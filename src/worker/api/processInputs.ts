...
const validateConferenceTournaments = (params: Params) => {
	return {
		season: validateSeason(params.season),
		cid: params.cid !== undefined ? parseInt(params.cid) : undefined,
	};
};
...
export default {
	...
	playerGraphs,
	playerStats,
	conferenceTournaments: validateConferenceTournaments,
