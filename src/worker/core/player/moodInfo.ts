...
const moodInfo = async (
	...
	// Up to 50% penalty for bad mood (no rookie contracts in college basketball)
	const autoRookieContract = false; // Removed: no rookie contracts in college
	...
	if (
		...
		// Removed: no rookie contracts in college basketball
		probWilling = 1;
		willing = true;
	} else {
