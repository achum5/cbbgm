...
const generate = (tm: any): Team => {
	...
	const t: Team = {
		...
		// College basketball prestige
		prestigeBase: tm.prestigeBase ?? 70, // Historical baseline prestige (0-100)
		prestige: tm.prestige ?? tm.prestigeBase ?? 70, // Current dynamic prestige (starts at prestigeBase)
	};
