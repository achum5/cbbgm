...
const defaultGameAttributes: GameAttributesLeagueWithHistory = {
	...
	godMode: false,
	godModeInPast: false,
	salaryCap: 1, // [thousands of dollars] - Minimal value (will be replaced with scholarship system)
	minPayroll: 0, // [thousands of dollars] - No payroll in college
	luxuryPayroll: 1, // [thousands of dollars] - Minimal value
	luxuryTax: 0,
	minContract: 1, // [thousands of dollars] - Minimal value (will be replaced with scholarship system)
	maxContract: 5000, // [thousands of dollars] - Reduced from NBA (will be replaced with scholarship system)
	minContractLength: 1,
	maxContractLength: 4, // 4-year max college careers
	minRosterSize: 10, // Minimum roster size
	maxRosterSize: 17, // Total roster size (scholarships + walk-ons)
	maxScholarships: 13, // NCAA Division I scholarship limit
	softCapTradeSalaryMatch: 125,
	numGames: wrap(34), // per season - College plays ~30-34 games
	numGamesDiv: 0, // Not used in college
	numGamesConf: 20, // Conference games (14 non-conference games) - realistic college schedule
	otherTeamsWantToHire: false,
	numPeriods: 2, // per game - College plays 2 halves, not 4 quarters
	quarterLength: 20, // [minutes] - 20-minute halves
	overtimeLength: 5,
	overtimeLengthPlayoffs: null,
	confs: wrap(DEFAULT_CONFS),
	divs: wrap(DEFAULT_DIVS),
	numGamesPlayoffSeries: wrap([7, 7, 7, 7, 7]),
	numPlayoffByes: wrap(7),
	aiTradesFactor: 1,
	stopOnInjury: false,
	...
	sonRate: 0.02,
	brotherRate: 0.02,
	forceRetireAge: 23, // Force retirement at age 23 (players leave after age 22 season)
	forceRetireSeasons: 4, // Max 4 seasons of play (plus 1 redshirt = 5 total years max)
	minRetireAge: 22, // Players "retire" (leave college) at 22
	groupScheduleSeries: false,

	salaryCapType: "none", // No salary cap in college basketball
	...
	numDraftRounds: 1, // College draft is 1 round only
	draftAges: [17, 18], // High school seniors entering as freshmen (17-18 years old)
	defaultStadiumCapacity: DEFAULT_STADIUM_CAPACITY,
	playersRefuseToNegotiate: true,
	allStarGame: -1, // No All-Star game in college basketball
	allStarNum: 12,
	allStarType: "byConf",
	allStarDunk: false, // No dunk contest in college
	allStarThree: false, // No 3-point contest in college
	budget: false, // Disabled for college - coaches don't control athletic budgets
	numSeasonsFutureDraftPicks: 4,
	foulRateFactor: 1,
	foulsNeededToFoulOut: 5, // NCAA rule: 5 fouls to foul out
	foulsUntilBonus: [7, 10, 0], // NCAA: bonus at 7 team fouls, double bonus at 10
