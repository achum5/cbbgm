...
type RealPlayersInfo =
	| {
			MIN_SEASON: number;
			MAX_SEASON: number;
			MAX_PHASE: Phase;
			FIRST_SEASON_WITH_ALEXNOOB_ROSTERS: number;
			legends: boolean;
	  }
	| undefined;
...
const PHASE_TEXT = {
	...
	"0": "preseason",
	"1": "regular season",
	"2": "after trade deadline",
	"3": bySport({
		// Would be better to read from g.get("numGamesPlayoffSeries")
		football: "playoffs",
		default: "playoffs",
	}),
	"4": bySport({
	...
	"6": "after draft",
	"7": bySport({
		football: "re-sign players",
		default: "re-sign players",
	}),
	"8": "free agency",
};
...
const GAME_NAME = bySport({
	...
	basketball: "College Basketball Coach",
...
const REAL_PLAYERS_INFO: RealPlayersInfo = bySport({
	baseball: undefined,
	basketball: undefined, // College basketball doesn't have historical rosters
	football: undefined,
	hockey: undefined,
});
