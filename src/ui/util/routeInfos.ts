const routeInfos = {
	...
	"/l/:lid/conference_tournaments": "conferenceTournaments",
	"/l/:lid/conference_tournaments/:season": "conferenceTournaments",
	"/l/:lid/conference_tournaments/:season/:cid": "conferenceTournaments",
