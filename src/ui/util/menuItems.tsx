...
const menuItems: (MenuItemLink | MenuItemHeader)[] = [
	...
	},
	{
		...
		children: [
			...
			{
				type: "link",
				active: (pageID) => pageID === "conferenceTournaments",
				league: true,
				commandPalette: true,
				path: ["conference_tournaments"],
				text: "Conference Tournaments",
			},
			{
				type: "link",
			...
			// Removed league_finances for college basketball - not relevant for coaches
			{
				type: "link",
	...
	},
	{
		...
		children: [
			...
			// Removed team_finances for college basketball - coaches don't manage budgets
			{
				type: "link",
	...
	},
	{
		...
		children: [
			...
			// COLLEGE MODE: Trading disabled for college basketball
			// Trade, Trading Block, Trade Proposals, and Saved Trades menu items removed
			// Backend trade logic kept intact for future recruiting/transfer features
			{
				type: "link",
				active: (pageID) =>
