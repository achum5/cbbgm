		...
		return {
			...
			data: [
				...
				season === "career"
					...
					: (() => {
							const ageInSeason = p.stats.season - p.born.year;
							const classInSeason = helpers.getCollegeClassForSeason(
								p.born.year,
								p.draft.year,
								p.stats.season,
							);
							return helpers.formatPlayerAge(ageInSeason, classInSeason);
						})(),
