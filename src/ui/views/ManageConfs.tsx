...
const EditTeamModal = ({
	...
	if (t && (!controlledTeam || controlledTeam.tid !== t.tid)) {
		setControlledTeam({
			...
			prestigeBase: String(t.prestigeBase),
			prestige: String(t.prestige),
	...
	const save = () => {
		...
		onSave({
			...
			prestigeBase: helpers.localeParseFloat(controlledTeam.prestigeBase),
			prestige: helpers.localeParseFloat(controlledTeam.prestige),
