	...
	return (
		<>
			...
			<div className={classNamesCol[4]}>
				<div className="mb-3">
					<label className={classNameLabel}>Historical Prestige</label>
					<input
						type="text"
						className="form-control"
						disabled={disablePop}
						onChange={(e) => handleInputChange("prestigeBase", e)}
						value={t.prestigeBase}
					/>
				</div>
			</div>
			<div className={classNamesCol[5]}>
				<div className="mb-3">
					<label className={classNameLabel}>Current Prestige</label>
					<input
						type="text"
						className="form-control"
						disabled={disablePop}
						onChange={(e) => handleInputChange("prestige", e)}
						value={t.prestige}
					/>
				</div>
			</div>
