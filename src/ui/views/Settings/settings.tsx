...
export const settings: Setting[] = (
	[
		...
		},
		{
			...
			godModeRequired: "always",
			type: "bool",
			hidden: true, // Hidden for college basketball - coaches don't control budgets
			descriptionLong: (
				<>
					<p>
		...
		// COLLEGE MODE: Trade Deadline setting removed for college basketball
		// Backend trade deadline logic kept intact for future recruiting deadlines
		{
			category: "Schedule",
