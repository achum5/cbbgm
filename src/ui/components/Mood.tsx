...
const componentText = (
	...
	if (value > 0) {
		switch (component) {
			case "prestige":
				return "Likes playing for a prestigious program";
			case "facilities":
				return "Likes the excellent team facilities";
			case "teamPerformance":
				return "Happy with the team's performance";
			case "tournament":
				return "Excited about tournament success";
			case "homeProximity":
				return "Happy to be close to home";
			case "playingTime":
	...
	switch (component) {
		case "prestige":
			return "Wants to play for a more prestigious program";
		case "facilities":
			return "Dislikes the outdated team facilities";
		case "teamPerformance":
			return "Unhappy with the team's performance";
		case "tournament":
			return "Disappointed with tournament results";
		case "homeProximity":
			return "Wishes the school was closer to home";
		case "playingTime":
